...
#####packages to install - only need to install things once
...
##Chidata<- read.spss("/Users/aller405/Desktop/BASIC_updated_22nov_na.rm.sav")  ####change path for your data

###Chi data dep ### 
Chidata_dep<- df_11_12epds
View(Chidata_dep)        #### look at our data (dont need to run this!)
attach(Chidata_dep)      #### means R can search our data and find column titles 

###Chi data anxiety ### 
Chidata_anx<- df_ppbeck
View(Chidata_anx)        #### look at our data (dont need to run this!)
attach(Chidata_anx)      #### means R can search our data and find column titles 
#####
...
###DEP/POB 
chi2_dep_POB <-table(POB,Chidata_dep$ppv6_EPDS_10_11R)  ###create crosstab Cross tab is called Newyouk- we analyse this
...
chi2_dep_POB <-table(POB,ppv6_EPDS_10_11R)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_POB)               ###show table
summary(chi2_dep_POB)              ###run chi squared 
cramersV(chi2_dep_POB)             ###produce cramers V -requires the lsr package out of your library
...
chi2_anx_POB <-table(POB_anx,ppv6beck)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_POB)               ###show table
summary(chi2_anx_POB)              ###run chi squared 
cramersV(chi2_anx_POB)             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_EDU <-table(EDU_epds,EDU_epds_df$ppv6_EPDS_10_11R)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_EDU)               ###show table
summary(chi2_dep_EDU)              ###run chi squared 
cramersV(chi2_dep_EDU)             ###produce cramers V -requires the lsr package out of your library
...
chi2_anx_EDU <-table(EDU_beck,EDU_beck_df$ppv6_beck_score_R_01)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_EDU)               ###show table
summary(chi2_anx_EDU)              ###run chi squared 
cramersV(chi2_anx_EDU)             ###produce cramers V -requires the lsr package out of your library
...
chi2_anx_EDU  <-table(YNedu_anx,ppv6_beck_score_R_01)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_EDU )               ###show table
summary(chi2_anx_EDU )              ###run chi squared 
cramersV(chi2_anx_EDU )             ###produce cramers V -requires the lsr package out of your library
prop.table(chi2_anx_EDU , 2)       ###as proportions 
...
chi2_dep_sleep  <-table(SLEEP_epds,EPDS)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_sleep)               ###show table
summary(chi2_dep_sleep)              ###run chi squared 
cramersV(chi2_dep_sleep )             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_sleep  <-table(df_short_complete$SLEEP,df_short_complete$ppEPDS)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_sleep)               ###show table
summary(chi2_dep_sleep)              ###run chi squared 
cramersV(chi2_dep_sleep )             ###produce cramers V -requires the lsr package out of your library
prop.table(chi2_dep_sleep, 2)       ###as proportions 
...
chi2_anx_sleep  <-table(SLEEP_beck,BECK)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_sleep)               ###show table
summary(chi2_anx_sleep)              ###run chi squared 
cramersV(chi2_anx_sleep)             ###produce cramers V -requires the lsr package out of your library
...
chi2_anx_age  <-table(AGE_beck,BECK)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_age)               ###show table
summary(chi2_anx_age)              ###run chi squared 
cramersV(chi2_anx_age)             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_age  <-table(AGE_epds,EPDS)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_age)               ###show table
summary(chi2_dep_age)              ###run chi squared 
cramersV(chi2_dep_age)             ###produce cramers V -requires the lsr package out of your library
...
### DO not have to remove NA beforehand if using napair

chi2_dep_PAR <- table(napair(PAR_epds,EPDS))  ###create crosstab Cross tab is called Newyouk- we analyse this
View(chi2_dep_PAR)
ftable(chi2_dep_PAR)               ###show table
summary(chi2_dep_PAR)              ###run chi squared 
cramersV(chi2_dep_PAR)             ###produce cramers V -requires the lsr package out of your library
prop.table(chi2_dep_PAR, 2)       ###as proportions 

###Parity + ANX###
PAR_beck <- as.numeric(df_beck$NK_parity_D)

chi2_anx_PAR <- table(napair(PAR_beck,BECK))  ###create crosstab Cross tab is called Newyouk- we analyse this
View(chi2_anx_PAR)
ftable(chi2_anx_PAR)               ###show table
summary(chi2_anx_PAR)              ###run chi squared 
cramersV(chi2_anx_PAR)             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_Ill <- table(napair(Ill_epds,EPDS))  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_Ill)               ###show table
summary(chi2_dep_Ill)              ###run chi squared 
cramersV(chi2_dep_Ill)             ###produce cramers V -requires the lsr package out of your library
...
chi2_anx_Ill <- table(napair(Ill_beck,BECK))  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_Ill)               ###show table
summary(chi2_anx_Ill)              ###run chi squared 
cramersV(chi2_anx_Ill)             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_DEP <- table(napair(DEP_epds,EPDS))  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_DEP)               ###show table
summary(chi2_dep_DEP)              ###run chi squared 
cramersV(chi2_dep_DEP)             ###produce cramers V -requires the lsr package out of your library
...
chi2_anx_DEP <- table(napair(DEP_beck,BECK))  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_DEP)               ###show table
summary(chi2_anx_DEP)              ###run chi squared 
cramersV(chi2_anx_DEP)             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_FOD <- table(FOD_epds,EPDS)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_FOD)               ###show table
summary(chi2_dep_FOD)              ###run chi squared 
cramersV(chi2_dep_FOD)             ###produce cramers V -requires the lsr package out of your library
...
chi2_anx_FOD <- table(FOD_beck,BECK)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_FOD)               ###show table
summary(chi2_anx_FOD)              ###run chi squared 
cramersV(chi2_anx_FOD)             ###produce cramers V -requires the lsr package out of your library
prop.table(chi2_anx_FOD, 2)       ###as proportions 

#### SSRI + ePDS####
SSRI_epds <-  as.numeric(df_epds$NK_SSRI_pregnancy_loose)

chi2_dep_SSRI <- table(SSRI_epds,EPDS)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_SSRI)               ###show table
summary(chi2_dep_SSRI)              ###run chi squared 
cramersV(chi2_dep_SSRI)             ###produce cramers V -requires the lsr package out of your library
...
chi2_anx_SSRI <- table(SSRI_beck,BECK)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_SSRI)               ###show table
summary(chi2_anx_SSRI)              ###run chi squared 
cramersV(chi2_anx_SSRI)             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_RS14 <- table(RS14_epds,EPDS)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_RS14)               ###show table
summary(chi2_dep_RS14)              ###run chi squared 
cramersV(chi2_dep_RS14)             ###produce cramers V -requires the lsr package out of your library
...
chi2_anx_RS14 <- table(RS14_beck,BECK)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_RS14)               ###show table
summary(chi2_anx_RS14)              ###run chi squared 
cramersV(chi2_anx_RS14)             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_DEP32 <- table(DEP32_epds,EPDS)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_DEP32)               ###show table
summary(chi2_dep_DEP32)              ###run chi squared 
cramersV(chi2_dep_DEP32)             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_DEP32_10_11 <- table(DEP32_epds_10_11,EPDS)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_DEP32_10_11)               ###show table
summary(chi2_dep_DEP32_10_11)              ###run chi squared 
cramersV(chi2_dep_DEP32_10_11)             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_DEP32 <- table(napair(DEP32_beck,BECK))  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_DEP32)               ###show table
summary(chi2_dep_DEP32)              ###run chi squared 
cramersV(chi2_dep_DEP32)             ###produce cramers V -requires the lsr package out of your library
prop.table(chi2_dep_DEP32, 2)       ###as proportions 
...
chi2_anx_DEP32_10_11 <- table(DEP32_beck_10_11,BECK)  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_DEP32_10_11)               ###show table
summary(chi2_anx_DEP32_10_11)              ###run chi squared 
cramersV(chi2_anx_DEP32_10_11)             ###produce cramers V -requires the lsr package out of your library
...
chi2_anx_ANX32 <- table(napair(BECK32_beck,BECK))  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_anx_ANX32)               ###show table
summary(chi2_anx_ANX32)              ###run chi squared 
cramersV(chi2_anx_ANX32)             ###produce cramers V -requires the lsr package out of your library
...
chi2_dep_DEP32 <- table(napair(BECK32_beck,BECK))  ###create crosstab Cross tab is called Newyouk- we analyse this
ftable(chi2_dep_DEP32)               ###show table
summary(chi2_dep_DEP32)              ###run chi squared 
cramersV(chi2_dep_DEP32)             ###produce cramers V -requires the lsr package out of your library
prop.table(chi2_dep_DEP32, 2)       ###as proportions 
